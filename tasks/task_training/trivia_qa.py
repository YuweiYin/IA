...
class TaskTrainingTriviaQA(TaskManager):
    ...
    def __init__(
        ...
        self.task_name = "trivia_qa_training"
        self.task_info = {
            "task_name": self.task_name,
            "task_type": "open_qa",
            "eval": [
                ["mandarjoshi/trivia_qa", "rc.wikipedia", "train"],
            ],
            "num_to_eval": -1,  # The # of items per subtask in "eval" set (if exists) for evaluation. -1: use all
        }
        # >>> [rc.wikipedia] >>> #Sub-Tasks = 1; #Items = 61888; avg_len_token: 59.5; std_len_token: 9.4; skip_cnt = 0
...
Here is the context information for answering this question:
{context_str}

We already know the correct answer is {answers_sort[0]}
